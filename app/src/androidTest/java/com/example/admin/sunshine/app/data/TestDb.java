...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // Validate we receive a row back;
        ...
        assertFalse("Error: More than one entry returned", c.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        ContentValues testWeatherValues = TestUtilities.createWeatherValues(locationId);
        // Insert ContentValues into database and get a row ID back
        long weatherRowId;
        weatherRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,null, testWeatherValues);
        assertTrue(weatherRowId != -1);
        // Query the database and receive a Cursor back
        Cursor c = db.query(WeatherContract.WeatherEntry.TABLE_NAME,null,null,null,null,null,null);
        // Move the cursor to a valid database row
        assertTrue("Error:  No rows returned from query", c.moveToNext());
        // Validate data in resulting Cursor with the original ContentValues
        TestUtilities.validateCurrentRecord("Error: Weather Query Validation Failed", c, testWeatherValues);
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        // Move the cursor to demonstrate that there is only one record in the database
        assertFalse( "Error: More than one record returned from weather query", c.moveToNext() );
